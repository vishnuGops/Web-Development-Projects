...
<div class="font">
    ...
    <div class = "PageTitle">
        <div class = "Title-text">
            <p style="font-size: 32px">USER DASHBOARD</p>
            <p>INICIO DE SESION -> USER </p>
        </div>
    </div>

    <h2 style="position: relative; left: 10%">Welcome <?php echo $_SESSION['email'];?>,</h2>
    <div class="register">
        <p style="font-size: 32px; text-align: center">Manage <span style="color: orange"><i>Profile</i></span></p>
        <div class="admin_buttons">

            <a href="Event_register.php"><input class= "submit_button" type="Submit" value="REGISTER FOR EVENTS "/></a></br>
        <a href="Events_view.php"> <input class= "submit_button" type="Submit" value="VIEW ALL EVENTS"/></a></br>
            <a href="Edit_profile.php"> <input class= "submit_button" type="Submit" value="EDIT PROFILE"/></a></br></br></br></br>
